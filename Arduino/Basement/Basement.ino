...
void loop() {
    ...
    if(bluetooth.available()){
     ...
     if (rxMsg.equals("poll")){
       ...
       sndData += ("||");
       sndData += ("wind1 tmp: ");
       sndData += windSensor1.ReadTmp();
       sndData += (" rv: ");
       sndData += windSensor1.ReadRv();
       sndData += ("||");
       sndData +=("motor2: ");
       sndData += servoAngle2;
       sndData += ("||");
        sndData += ("wind2 tmp: ");
       sndData += windSensor2.ReadTmp();
       sndData += (" rv: ");
       sndData += windSensor2.ReadRv();
       sndData += ("||");
       sndData +=("motor3: ");
       sndData += servoAngle3;
       sndData += ("||");
        sndData += ("wind3 tmp: ");
       sndData += windSensor3.ReadTmp();
       sndData += (" rv: ");
       sndData += windSensor3.ReadRv();
       sndData += ("||");       
       sndData +=("motor4: ");
       sndData += servoAngle4;
